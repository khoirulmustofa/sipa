...
<body>
  ...
  <?php
  if($id_skripsi!=null){
    $row = $this->m_monitoring_skripsi->get_row_data_skripsi($id_skripsi);
    if ($row) {
      ...
      <div style="padding: 5;">
        <p align="center">SURAT KEPUTUSAN DEKAN FAKULTAS TEKNIK UNIVERSITAS ISLAM RIAU <br> NOMOR : <?= $nomor_surat_full ?>
          <BR>TENTANG PENGANGKATAN TIM PEMBIMBING PENELITIAN DAN PENYUSUNAN SKRIPSI</p>
            <hr>
          ...
          <table border="0" cellpadding="1">
            <tbody>
              <tr>     
                <td colspan="2" align="justify">
                  Membaca : Surat Ketua Program Studi <?= $nama_prodi ?> <?= $nomor_surat_full ?> Tentang persetujuan dan usulan Pengangkatan Tim Pembimbing penelitian dan penyusunan Skripsi
                </td>  
              </tr>
              <tr>     
                <td colspan="2" align="justify">
                  Menimbang : 
                  <ol>
                    <li>Bahwa untuk menyelesaikan perkuliahan bagi mahasiswa Fakultas Teknik perlu membuat Skripsi.</li>
                    <li>Untuk itu perlu ditunjuk Tim Pembimbing penelitian dan penyusunan Skripsi yang diangkat dengan Surat Keputusan Dekan</li>
                  </ol>
                </td>  
              </tr>
              <tr>     
              ...
              <tr>
                <td colspan="2" align="justify">
                  Menetapkan :
                  <ol>
                    <li>Mengangkat saudara-saudara yang namanya tersebut dibawah ini sebagai Tim Pembimbing Penelitian & penyusunan Skripsi Mahasiswa/i Fakultas Teknik Program Studi <?php echo $nama_prodi ?>
                      <br><br>
           ...
           <tr>     
             ...
             <td width="50%">
              ...
              <u>Pada tanggal : 
                <?= $this->m_monitoring_skripsi->format_tanggal(date('Y-m-d', strtotime($waktu_input_ttd))); ?>
              </u><br>
              <?= $jabatan_penanda_tangan?>,<br>
              <?php 
              QRcode::png(site_url("/Validasi_ttd_digital/cek_fakultas/".$id_random),"templates/img/qrcode/barcode_sk_pembimbing_skripsi_".$id_random.".png");
              ?>
              <img src="<?php echo base_url("templates/img/qrcode/barcode_sk_pembimbing_skripsi_".$id_random.".png") ?>" width="100px"><br>
