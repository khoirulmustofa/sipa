...
<body>
  ...
  <?php
  if($id_skripsi!=null){
    $row = $this->m_penguji_skripsi->get_row_data_skripsi($id_skripsi);
    if ($row) {
              ...
              <td colspan="2" align="justify">
               ...
               <li>Penguji Seminar Proposal dan Sidang Skripsi mahasiswa tersebut terdiri dari :
                 <table> 
                   ...
                   <tr>
                     <td>2. <?php echo $this->m_penguji_skripsi->get_nama_penguji($id_syarat_sempro, 'Penguji 1'); echo $id_syarat_sempro; ?></td>
