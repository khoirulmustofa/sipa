<div class="col-lg-12 mb-1">
             ...
             <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead class="table table-primary">
                <tr>
                  ...
                  <td align="center"><b>SEMINAR KOMPREHENSIF</b></td>
                </tr>
              </thead>
              <tbody>
                <?php  
                ...
                <tr>
                  ...
                  <td>
                    ...
                    if ($this->m_penilaian->cekResponNilai($id_syarat_sempro, $npk)<=0) {      
                      ?>
                      <center><a data-toggle="modal" data-target="#ModalPenilaianSempro<?php echo $id_syarat_sempro ?>"><i class="fas fa-plus-circle text-primary"></i></a></center>
                       ...
                       <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body" >
                            <?php 
                            if ($this->m_penilaian->cekPosisi($npk, 'Penguji 1')) {      
                              ?>
                              <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('/dosen/penilaian_penguji/nilai_sempro')?>">
                      ...
                      <?php }else{ ?>
                      <center>
                        <i class="fas fa-eye text-primary" data-toggle="modal" data-target="#ModalLihatNilaiPenguji<?php echo $id_syarat_sempro  ?>"></i>
                      </center>
                      <?php } ?>
                    </td>
                    <td>
                      <?php if ($this->m_monitoring_kompre->cekPersetujuan_kompre($id_syarat_kompre)>0){ 
                          ...
                          <div class="modal fade" id="ModalPenilaianKompre<?php echo $id_syarat_sempro ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                           <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body" >
                               <?php 
                               if ($this->m_penilaian->cekPosisiKompre($npk, 'Penguji 1')) {      
                                ?>
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('/dosen/penilaian_penguji/nilai_kompre')?>">
                                  <div class="form-group">
                        ...
                        <center>
                          ...
                          <i class="fas fa-eye text-primary" data-toggle="modal" data-target="#ModalLihatNilaiPengujiKompre1<?php echo $id_syarat_kompre  ?>"></i>
                        </center>
  ...
  ?>
  <div class="modal fade" id="ModalLihatNilaiPenguji<?php echo $i['id_syarat_sempro']  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content text-left">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><b class="text-secondary">Penilaian Penguji</b></h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body"> 
          <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('/dosen/penilaian_penguji/row_data')?>">
            <div class="form-group">
              <label >Pendahuluan</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "pendahuluan", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 20%</small>
            </div>
            <div class="form-group">
              <label >Tinjauan</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "tinjauan", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 15%</small>
            </div>
            <div class="form-group">
              <label >Metodologi</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "metodologi", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 25%</small>
            </div>
            <div class="form-group">
              <label >Referensi</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "referensi", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 10%</small>
            </div>
            <div class="form-group">
              <label >Sistematika</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "sistematika", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 5%</small>
            </div>
            <div class="form-group">
              <label >Presentasi</label>
              <input type="number" name="kepribadian" class="form-control" value="<?php echo $this->m_penilaian->get_nilai($id_syarat_sempro, "presentasi", $posisi) ?>" readonly></input>
              <small class="text-primary">Bobot 25%</small>
            </div>
            <div class="modal-footer">
  ...
  ?>
  <div class="modal fade" id="ModalLihatNilaiPengujiKompre1<?php echo $i['id_syarat_kompre']  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content text-left">
        <div class="modal-header">
  ...
  ?>
  <div class="modal fade" id="ModalLihatNilaiPengujiKompre2<?php echo $i['id_syarat_kompre']  ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content text-left">
        <div class="modal-header">
