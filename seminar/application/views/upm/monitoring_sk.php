  ...
  <div class="card shadow mb-4">
    ...
    <div class="content"><br>
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-body">
           <form action="<?php echo site_url().'/upm/monitoring_sk'; ?>" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-4">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if (isset($id_syarat_sk)) {
                        ...
                        if($cekSK>0){
                          ?> 
                          <a target="_BLANK"  href="<?php echo site_url('/upm/monitoring_sk/cetak_sk_pembimbing_kp/').$id_syarat_sk ?>"><i class="fas fa-download text-success"></i></a>
                          <?php
                        } else {
