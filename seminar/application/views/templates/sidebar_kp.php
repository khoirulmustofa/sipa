            ...
            <li class="nav-item">
               ...
               <!--  <li class="nav-item">
                    ...
                    <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="<?php echo site_url(); ?>/tu/monitoring_sempro">Proposal</a>
                            <a class="collapse-item" href="<?php echo site_url(); ?>/tu/monitoring_kompre">Komprehensif</a>
                        </div>
                    </div>
                </li> -->
                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    ...
                                    <a class="collapse-item" href="<?php echo site_url(); ?>/prodi/monitoring_sk">Pembimbing KP</a>
                                </div>
                            </div>
                        </li>
                       <!--  <li class="nav-item">
                            ...
                            <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                                <div class="bg-white py-2 collapse-inner rounded">
                                    <a class="collapse-item" href="<?php echo site_url(); ?>/prodi/monitoring_skripsi">Pembimbing Skripsi</a>
                                    <a class="collapse-item" href="<?php echo site_url(); ?>/prodi/penguji_skripsi">Penguji Skripsi</a>
                                </div>
                            </div>
                        </li> -->
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                           ...
                           <!--  <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url(); ?>/dosen/penilaian">
                            ...
                            <li class="nav-item">
                               ...
                               <!--  <li class="nav-item">
                                    ...
                                    <div id="collapseUtilities3" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                                        <div class="bg-white py-2 collapse-inner rounded">
                                            <a class="collapse-item" href="<?php echo site_url(); ?>/mahasiswa/sempro">Proposal</a>
                                            <a class="collapse-item" href="<?php echo site_url(); ?>/mahasiswa/kompre">Komprehensif</a>
                                        </div>
                                    </div>
                                </li> -->
                                <li class="nav-item">
