<table border="1">
	<tr>
		<td width="30%">
			<div class="card shadow mb-4">
				...
				<div class="card-body " >
					...
					if($this->m_pembimbing_lapangan->cekResponNilai_pembimbing_lapangan($_SESSION['id_syarat_sk'])>0){
						...
						?>
						<center>
							<h5 class="modal-title" id="exampleModalLabel"><b class="text-primary">Silahkan Input Nilai Mahasiswa<br></b></h5></center>
							<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('/pembimbing_lapangan_kp/penilaian_kp/nilai_pembimbing_lapangan')?>">
								<div class="form-group text-left">
									...
									<input type="number" name="kepribadian" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) ===== 
								...
								<div class="form-group text-left">
									...
									<input type="number" name="kedisiplinan" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
								...
								<div class="form-group text-left">
									...
									<input type="number" name="motivasi" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) ===== 
								...
								<div class="form-group text-left">
									...
									<input type="number" name="tanggung_jawab" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
								...
								<div class="form-group text-left">
									...
									<input type="number" name="komitmen" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
								...
								<div class="form-group text-left">
									...
									<input type="number" name="kerjasama" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
								...
								<div class="form-group text-left">
									...
									<input type="number" name="keselamatan" class="form-control"  data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
								...
								<div class="form-group text-left">
									...
									<input type="number" name="laporan" class="form-control" data-toggle="tooltip" data-placement="right" title="
									===== (Nilai<=60) =====
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Rubrik Penilaian</h3>
				</div>
				<?php echo $this->session->flashdata('messege'); ?>
				<div class="card-body " >
					<?php 
					if($this->m_pembimbing_lapangan->cekResponNilai_pembimbing_lapangan($_SESSION['id_syarat_sk'])>0){
						...
						<center>
							...
							<form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo site_url('/pembimbing_lapangan_kp/penilaian_kp/nilai_pembimbing_lapangan')?>">
								<div class="form-group text-left">
									<label>Kepribadian<small class="text-primary"> (Nilai 0-100)</small></label>
									<input type="number" name="kepribadian" class="form-control" zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzyzzyzzyzzy></input>
									<script>
										$(document).ready(function(){
											$('[data-toggle="tooltip"] ').tooltip();
										})
