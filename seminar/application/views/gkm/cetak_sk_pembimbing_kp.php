...
<body>
  ...
  if($id_syarat_sk!=null){
    $row = $this->m_monitoring_sk->get_row_data_syarat_sk($id_syarat_sk);
    if ($row) {
            ...
            <tbody>
              <tr>     
                <td colspan="2" align="justify">
                  Membaca : Surat Ketua Program Studi <?= $nama_prodi ?> <?= $nomor_surat_full ?> Tentang Persetujuan dan Usulan Pengangkatan Tim Pembimbing Kerja Praktek
                </td>  
              </tr>
              <tr>     
                <td colspan="2" align="justify">
                     ...
                     <table border="0" width="100%">
                      <tbody>
                        <tr>           
                          ...
                          <td width="10">:</td>           
                          <td width="248"><?= $nama_mahasiswa ?></td>         
                        </tr>
                        <tr>           
                          <td>NPM</td>           
                          <td>:</td>           
