...
<body>
  ...
  if($id_syarat_sk!=null){
    $row = $this->m_bimbingan->get_row_data_bimbingan($id_syarat_sk);
    if ($row) {
          ...
          <tr>
            <td colspan="2" width="100%">
              <table border="0" id="table2">
                ...
                <tr>
                  <td style="vertical-align: top; text-align: left;">Judul Kerja Praktek</td>
              ...
              <table border="1" cellpadding="1" cellspacing="0" width="100%" id="table">
                ...
                <tbody>
                  <?php 
                  $no= 1;
                  foreach ($this->m_bimbingan->getDataBimbingan($id_syarat_sk) as $key) {

                    ?>
                    <tr>
                      <td align="center"><?php echo $no++ ?></td>
                      <td align="center"><?= $this->m_bimbingan->format_tanggal(date('Y-m-d', strtotime($key['waktu_input_ttd']))); ?></td>
                      ...
                      <td align="center">
                        ...
                        ?>
                        <img src="<?php echo base_url("templates/img/qrcode/barcode_kartu_bimbingan_".$key['id_random'].".png") ?>" width="100px"><br><i class="text-success"><?= $key['nama_penanda_tangan'] ?></i><br>
                  ...
                  <tr>     
                   ...
                   <td width="50%">
                     ...
                     if (isset($id_syarat_sk)) {
                      $cekValidasi = $this->m_monitoring_sk->cekTtdProdi($id_syarat_sk);
                      if($cekValidasi>0){
                        ?> 
                        Pekanbaru, <?= $this->m_monitoring_sk->format_tanggal(date('Y-m-d', strtotime($key['waktu_input_ttd']))); ?><br>Ketua Program Studi <?= $nama_prodi ?><br>

                        <?php 
                        $id_random_prodi = $this->m_bimbingan->getIdRandom($id_syarat_sk, 'Tandatangan kartu bimbingan Kerja Praktik oleh Prodi');
