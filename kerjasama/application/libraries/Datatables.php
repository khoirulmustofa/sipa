...
class Datatables
{
  ...
  private function get_filtering()
  {
    ...
    $sSearch = $this->ci->db->escape_like_str(trim(isset($search['value'])));
  ...
  private function produce_output($output, $charset)
  {
    ...
    if ($output == 'json') {
      $sOutput = array(
        ...
        'data'                => $aaData,
        // 'token_csrf'          => $this->CI->security->get_csrf_hash(),
      );
      if ($charset == 'utf-8')
  ...
  private function check_cType()
  {
    ...
    if (is_numeric(isset($column[0]['data'])))
      return FALSE;
    else
      return TRUE;
  }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-07-09 09:20:22 */
/* http://harviacode.com */