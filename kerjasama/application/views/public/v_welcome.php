<div class="main-panel">
	<div class="content">
				...
				<div class="col-md-12">
					<div class="card full-height">
						<div class="card-body text-center">
							...
							<h1>Selamat Datang di Sistem Pelaporan Akademik Fakultas Teknik (SiPA-FT) Universitas Islam Riau.</h1>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="page-inner mt--5">
			<div class="row mt--2">
				<?php if ($_SESSION['status_login'] == "UPM") { ?>
					...
					<div class="col-md-6">
						<div class="card full-height text-white bg-danger">
							...
							<div class="card-footer text-center bg-light">
								...
								<?php } else {
									echo '<div class="text-danger">Penambahan admin baru hanya bisa dilakukan oleh super admin.</div>';
								} ?>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header bg-warning rounded">
									<h2 class="text-white">
										<blink class="text-white">PENGUMUMAN</blink>
										<marquee class="text-danger bg-white">Matakuliah yang diampu oleh 2 atau 3 orang dosen, mohon melaporkan tatap muka melalui akun SiPA masing-masing...</marquee>
									</h2>
								</div>
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-10">
											...
											<div class="p-3 border rounded">
												...
												<ol type="a">
													<li>
														<h4>Jumlah pengajuan untuk bulan ini <b class="text-danger">(Oktober 2021)</b> tidak di batasi karena dalam masa tahap sosialisasi. Silahkan ajukan pengajuan ganti jadwal sejumlah pertemuan yang tertinggal. Karena bulan depan <b class="text-danger">(November 2021)</b> akan di terapkan jumlah pengajuan paling tinggi 2 kali.</h4>
													</li>
													<li>
											...
											<div class="p-3 border rounded">
												...
												<ol type="a">
													<li>
														<h4>Perekapan tatap muka dosen dilakukan berdasarkan tanggal melakukan input. <br>
															<b class="text-warning">Contoh :</b> Jika jadwal sebenarnya bulan September dan setelah diajukan jadwal ganti pada bulan Oktober, maka perekapannya akan masuk ke dalam bulan Oktober <b class="text-danger">(bukan September lagi)</b>
														</h4>
													</li>
													<li>
														<h4>Perhitungannya <b class="text-danger">0.5 per SKS</b>. Berikut penjelasannya : </h4>
													</li>
												</ol>
												<div class="row">
													<div class="col-md-6">
