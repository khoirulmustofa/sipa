...
class Kerja_sama_model extends CI_Model
{
    ...
    public function get_tb_kerjasama()
    {
        ...
        $this->datatables->join('master_kota_kabupaten as d', 'd.master_kota_kabupaten_id = a.kabupaten_kota_id', 'left');
        $this->datatables->join('master_kecamatan as e', 'e.master_kecamatan_id = a.kecamatan_id', 'left');
        $this->datatables->join('master_kelurahan as f', 'f.master_kelurahan_id = a.kelurahan_id', 'left');
