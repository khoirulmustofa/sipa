...
INSERT INTO `tbl_bimbingan` (`id_bimbingan`, `id_syarat_sk`, `bimbingan_ke`, `materi_bimbingan`, `hasil_bimbingan`, `jenis_pertemuan_bimbingan`, `file_lampiran`, `waktu_input_bimbingan`, `status`) VALUES
(336, 231, 1, 'bob', 'oiboi', 'Online', '', '2022-07-04 07:22:22', 'Tersedia'),
(337, 231, 2, 'jnoi', 'niuniu', 'Offline', '', '2022-07-04 07:22:47', 'Tersedia'),
(338, 231, 3, 'bon', 'ni', 'Online', '', '2022-07-04 07:23:12', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_bimbingan_skripsi`
--
...
--
-- Dumping data for table `tbl_dospem`
--

INSERT INTO `tbl_dospem` (`id_dospem`, `id_syarat_sk`, `npk`, `tgl_pengajuan`, `respon`, `tgl_respon`, `alasan_ditolak`, `status`) VALUES
(171, 215, '51023048901', '2022-06-28 04:03:10', 'Penunjukan Diterima Pembimbing', '0000-00-00 00:00:00', '', 'Tersedia'),
(172, 231, '51023048901', '2022-07-04 07:19:44', 'Penunjukan Diterima Pembimbing', '0000-00-00 00:00:00', '', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_dospem_skripsi`
--
...
--
-- Table structure for table `tbl_file_kp`
--
...
--
-- Dumping data for table `tbl_file_kp`
--

INSERT INTO `tbl_file_kp` (`id_file_kp`, `id_syarat_sk`, `nama_file`, `waktu_upload`, `file`, `status`) VALUES
(257, 231, 'Laporan P1', '2022-07-04 07:22:08', '20220704142208LAPORAN P2.pdf', 'Tersedia'),
(258, 231, 'Laporan P2', '2022-07-04 07:22:36', '20220704142236LAPORAN LENGKAP.pdf', 'Tersedia'),
(259, 231, 'Laporan P3', '2022-07-04 07:22:55', '20220704142255LAPORAN P2.pdf', 'Tersedia'),
(260, 231, 'Laporan Lengkap', '2022-07-04 07:23:21', '20220704142321LAPORAN P3.pdf', 'Tersedia');
...
--
-- Table structure for table `tbl_gkm`
--
...
--
-- Dumping data for table `tbl_gkm`
--
...
--
-- Table structure for table `tbl_jenis_sk`
--
...
--
-- Dumping data for table `tbl_jenis_sk`
--
...
INSERT INTO `tbl_nilai` (`id_nilai`, `id_syarat_sk`, `sikap`, `pemahaman`, `kelengkapan`, `status_verifikasi_prodi`, `status`) VALUES
(128, 231, 89, 9, 97, 'Terverifikasi', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_nilai_kompre`
--
...
--
-- Table structure for table `tbl_nilai_sempro`
--
...
--
-- Table structure for table `tbl_nomor_surat`
--
...
--
-- Dumping data for table `tbl_nomor_surat`
--

INSERT INTO `tbl_nomor_surat` (`id_nomor_surat`, `fungsi_nomor`, `relasi_tabel`, `id_relasi`, `nomor_surat`, `tahun`, `status`) VALUES
(490, 'Surat Pengantar Instansi KP', 'tbl_surat_pengantar', 253, 1, 2022, 'Tersedia'),
(491, 'Surat Pengantar Instansi KP', 'tbl_surat_pengantar', 255, 2, 2022, 'Tersedia'),
(492, 'Surat Pengantar Permohonan Penelitian', 'tbl_surat_pengantar_penelitian', 52, 3, 2022, 'Tersedia'),
(493, 'Surat Pengantar Instansi KP', 'tbl_surat_pengantar', 256, 4, 2022, 'Tersedia'),
(494, 'SK Pembimbing KP', 'tbl_syarat_sk', 231, 1, 2022, 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_open_file`
--
...
--
-- Dumping data for table `tbl_open_file`
--

INSERT INTO `tbl_open_file` (`id_open_file`, `id_syarat_sk`, `waktu_open_file`, `pelaku`, `jabatan`, `file_open`, `status`) VALUES
(429, 215, '2022-04-26 04:36:05', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(430, 215, '2022-04-26 04:36:12', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(431, 215, '2022-04-26 04:36:14', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(432, 215, '2022-04-26 04:36:16', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia'),
(433, 217, '2022-05-31 06:45:51', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(434, 221, '2022-06-07 05:49:45', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(435, 223, '2022-06-20 02:23:23', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(436, 223, '2022-06-20 02:23:26', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(437, 223, '2022-06-20 02:23:28', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(438, 223, '2022-06-20 02:23:30', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia'),
(439, 224, '2022-06-20 02:34:37', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(440, 224, '2022-06-20 02:34:39', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(441, 224, '2022-06-20 02:34:41', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(442, 224, '2022-06-20 02:34:42', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia'),
(443, 229, '2022-06-22 14:48:10', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(444, 229, '2022-06-22 14:48:12', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(445, 229, '2022-06-22 14:48:14', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia'),
(446, 229, '2022-06-22 15:02:29', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(447, 231, '2022-06-22 15:33:47', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(448, 231, '2022-06-22 15:33:50', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(449, 231, '2022-06-22 15:33:52', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(450, 231, '2022-06-22 15:33:55', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia'),
(451, 233, '2022-06-23 04:06:50', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(452, 233, '2022-06-23 04:06:53', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(453, 233, '2022-06-23 04:07:00', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa', 'Tersedia'),
(454, 233, '2022-06-23 04:07:02', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_open_file_kompre`
--
...
--
-- Table structure for table `tbl_open_file_sempro`
--
...
--
-- Table structure for table `tbl_open_file_skripsi`
--
...
INSERT INTO `tbl_pembimbing_lapangan` (`id_pembimbing_lapangan`, `id_syarat_sk`, `kepribadian`, `kedisiplinan`, `motivasi`, `tanggung_jawab`, `komitmen`, `kerjasama`, `keselamatan`, `laporan`, `status_verifikasi_prodi`, `status`) VALUES
(112, 233, 7, 7, 7, 7, 7, 77, 7, 7, '', 'Tersedia'),
(119, 231, 67, 67, 67, 67, 67, 67, 67, 6, 'Terverifikasi', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_penguji_skripsi`
--
...
--
-- Table structure for table `tbl_persetujuan_kompre`
--
...
--
-- Table structure for table `tbl_persetujuan_sempro`
--
...
--
-- Table structure for table `tbl_persetujuan_sk`
--
...
--
-- Dumping data for table `tbl_persetujuan_sk`
--

INSERT INTO `tbl_persetujuan_sk` (`id_persetujuan_sk`, `id_syarat_sk`, `waktu_persetujuan`, `pelaku`, `jabatan`, `status_persetujuan`, `tema_persetujuan`, `alasan_ditolak`, `status`) VALUES
(910, 233, '2022-06-29 08:01:09', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Dihapus'),
(911, 233, '2022-06-29 08:01:10', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Dihapus'),
(912, 233, '2022-06-29 08:01:12', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(913, 233, '2022-06-29 08:01:13', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(914, 231, '2022-06-29 08:01:25', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Ditolak', 'Pengecekan Berkas Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'dsad', 'Dihapus'),
(915, 231, '2022-06-29 08:01:30', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Ditolak', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Berkas Tidak Sesuai Standar, Silahkan Cek Kembali Berkas, ', 'Dihapus'),
(916, 231, '2022-06-29 08:01:35', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Ditolak', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'as', 'Dihapus'),
(917, 231, '2022-06-29 08:01:40', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Ditolak', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'q', 'Dihapus'),
(918, 215, '2022-06-29 08:02:01', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(919, 215, '2022-06-29 08:02:07', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Ditolak', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', 'Berkas Tidak Sesuai Standar, Silahkan Cek Kembali Berkas, ', 'Dihapus'),
(920, 215, '2022-06-29 08:02:08', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(921, 215, '2022-06-29 08:02:09', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(922, 233, '2022-06-29 08:03:04', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(923, 231, '2022-06-29 08:03:08', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Dihapus'),
(924, 215, '2022-06-29 08:03:15', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(925, 231, '2022-06-29 08:04:16', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Dihapus'),
(926, 231, '2022-06-29 08:12:08', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Bukti Penerimaan Lapangan untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(927, 231, '2022-06-29 08:12:09', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas SPP dasar untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(928, 231, '2022-06-29 08:12:11', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Transkip Nilai Sementara untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(929, 231, '2022-06-29 08:12:12', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan File Laporan KP untuk Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia'),
(930, 231, '2022-07-04 07:11:45', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', 'Pengecekan Berkas Pengajuan SK Kerja Praktik Mahasiswa oleh Tata Usaha', '', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_persetujuan_skripsi`
--
...
--
-- Table structure for table `tbl_persetujuan_surat_pengantar`
--
...
--
-- Dumping data for table `tbl_persetujuan_surat_pengantar`
--

INSERT INTO `tbl_persetujuan_surat_pengantar` (`id_persetujuan_surat_pengantar`, `id_surat_pengantar`, `waktu_persetujuan`, `pelaku`, `jabatan`, `status_persetujuan`, `alasan_ditolak`, `status`) VALUES
(306, 252, '2022-04-26 04:28:26', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(307, 252, '2022-04-26 04:29:08', 'Dr. Apri Siswanto S.Kom M.Kom', 'Staff Prodi Teknik', 'Berkas Ditolak', 'Perusahaan/Instansi yang diajukan Tidak Sesuai, ', 'Tersedia'),
(308, 253, '2022-04-26 04:31:07', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(309, 253, '2022-04-26 04:31:21', 'Dr. Apri Siswanto S.Kom M.Kom', 'Staff Prodi Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(310, 255, '2022-05-30 15:44:51', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(311, 255, '2022-05-30 15:44:56', 'Dr. Apri Siswanto S.Kom M.Kom', 'Staff Prodi Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(312, 256, '2022-06-23 03:53:59', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(313, 256, '2022-06-23 03:54:20', 'Muhammad', 'Staff Prodi Teknik', 'Berkas Disetujui', '', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_persetujuan_surat_pengantar_penelitian`
--
...
--
-- Dumping data for table `tbl_persetujuan_surat_pengantar_penelitian`
--

INSERT INTO `tbl_persetujuan_surat_pengantar_penelitian` (`id_persetujuan_surat_pengantar_penelitian`, `id_surat_pengantar_penelitian`, `waktu_persetujuan`, `pelaku`, `jabatan`, `status_persetujuan`, `alasan_ditolak`, `status`) VALUES
(65, 52, '2022-06-06 04:45:27', 'Tata Usaha FT', 'Staff Tata Usaha Teknik', 'Berkas Disetujui', '', 'Tersedia'),
(66, 52, '2022-06-06 04:45:41', 'Dr. Apri Siswanto S.Kom M.Kom', 'Staff Prodi Teknik', 'Berkas Disetujui', '', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_persetujuan_usulan_pembimbing`
--
...
INSERT INTO `tbl_skripsi` (`id_skripsi`, `id_jenis_sk`, `npm`, `judul`, `file_spp`, `file_transkrip`, `file_krs`, `file_laporan`, `tgl_upload`, `status`) VALUES
(65, 2, '183510400', 'nfpN', '20220704155747SKRIPSI.pdf', '20220704155747LAPORAN P1.pdf', '20220704155747LAPORAN P2.pdf', '20220704155747SK.pdf', '2022-07-04 08:57:47', 'Tersedia');
...
INSERT INTO `tbl_surat_pengantar` (`id_surat_pengantar`, `npm`, `nama_instansi`, `alamat_instansi`, `lokasi`, `ditujukan`, `waktu_mulai`, `judul_kp`, `waktu_selesai`, `nama_file_surat_pengantar`, `lampiran`, `tgl_upload_surat_pengantar`, `status`) VALUES
(252, '183510393', 'PT. Indo', 'Jl. Abc NO. 12', 'Sumatera Barat', 'HRD', '2022-04-26', '', '2022-01-26', '20220426112354SPP.pdf', '', '2022-04-26 04:23:54', 'Tersedia'),
(253, '183510393', 'UIR', 'Jl. Kaharuddin', 'Pekanbaru', 'Rektor', '2022-04-08', '', '2022-04-29', '20220426113034SK.pdf', '', '2022-04-26 04:30:34', 'Tersedia'),
(254, '183510393', 'dsa', 'adasd', 'Duri ', 'Dekan', '2022-04-06', '', '2022-04-29', '20220428221912SKRIPSI.pdf', '', '2022-04-28 15:19:12', 'Tersedia'),
(255, '183510400', 'das', 'dsa', 'Duri ', 'Camat', '2022-05-13', '', '2022-05-25', '20220530224430SKRIPSI.pdf', '', '2022-05-30 15:44:30', 'Tersedia'),
(256, '173110270', 'uir', 'jl. kaharuddin', 'Pekanbaru', 'Rektor', '2022-06-01', 'Sistem Informasi Arsip Dosen', '2022-07-01', '20220623105336LAMPIRAN.pdf', '', '2022-06-23 03:53:36', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_surat_pengantar_penelitian`
--
...
--
-- Dumping data for table `tbl_surat_pengantar_penelitian`
--

INSERT INTO `tbl_surat_pengantar_penelitian` (`id_surat_pengantar_penelitian`, `npm`, `nama_instansi`, `alamat_instansi`, `ditujukan`, `judul_penelitian`, `matakuliah`, `file_spp`, `file_ktm`, `file_sk`, `tgl_upload_surat_pengantar_penelitian`, `status`) VALUES
(52, '183510400', 'fw', 'fq', 'Pimpinan', 'fwq', 'Skripsi', '20220606114518SPP.pdf', '20220606114518KTM.pdf', '20220606114518KRS.pdf', '2022-06-06 04:45:18', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_syarat_kompre`
--
...
--
-- Table structure for table `tbl_syarat_sempro`
--
...
--
-- Table structure for table `tbl_syarat_sk`
--
...
--
-- Dumping data for table `tbl_syarat_sk`
--

INSERT INTO `tbl_syarat_sk` (`id_syarat_sk`, `id_jenis_sk`, `npm`, `nama_tempat_kp`, `judul_kerja_praktik`, `nama_pembimbing_lapangan`, `no_hp_pembimbing_lapangan`, `email_pembimbing_lapangan`, `string_random`, `waktu_mulai_kp`, `waktu_selesai_kp`, `nama_file_syarat_sk`, `file_spp_dasar`, `file_transkrip`, `file_laporan`, `tgl_upload_syarat_sk`, `status`) VALUES
(215, 1, '183510393', '253', 'Sistem Testing', 'Budi', '081371386', 'nadiarozaan@student.uir.ac.id', 'SUQDT2KDvG', '2022-04-13', '2022-04-27', '20220426113457KRS.pdf', '20220524051840SPP.pdf', '20220426113457LAPORAN P1.pdf', '20220426063701LAPORAN P3.pdf', '2022-05-24 03:18:40', 'Tersedia'),
(231, 1, '183510400', '255', 'bi', 'guiu', '687', 'fitrisafnita@student.uir.ac.id', 'fRRsSWUX2I', '2022-06-23', '2022-06-03', '20220622223259LAPORAN P2.pdf', '20220622223259LAMPIRAN.pdf', '20220622223259LAMPIRAN.pdf', '20220622223259LAMPIRAN.pdf', '2022-06-22 15:32:59', 'Tersedia'),
(235, 1, '173110270', '256', 'vawf', 'a', '8768', 'giug', '4nRGPIIgd6', '0098-08-07', '0798-07-09', '20220704172814SKRIPSI.pdf', '20220704172814LAPORAN P1.pdf', '20220704172814KTM.pdf', '20220704172814TRANSKRIP.pdf', '2022-07-04 10:28:14', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_ttd_dospem`
--
...
--
-- Dumping data for table `tbl_ttd_dospem`
--

INSERT INTO `tbl_ttd_dospem` (`id_ttd_dospem`, `id_relasi`, `topik_relasi`, `id_random`, `waktu_input_ttd`, `nama_penanda_tangan`, `jabatan_penanda_tangan`, `perihal`, `status_validasi`, `status`) VALUES
(524, 336, 'Tandatangan bimbingan Kerja Praktik oleh Dosen Pembimbing', 'OV3zDJl2c2d9KsMtJw50y2HgPk486uAl8m3UBRnjCWu7roxQikc1joNqPH1ypZCGpqh2iKTE9rdzTtF0413Zbvsh78YxAwX9Ygff', '2022-07-04 07:22:22', 'Dr. ARBI HAZA NASUTION  B.IT(Hons).  M.IT.', 'Dosen Pembimbing Kerja Praktik', 'Tandatangan bimbingan Kerja praktik atas nama Fitri Safnita (183510400) pertemuan ke-1', 'Tervalidasi', 'Tersedia'),
(525, 337, 'Tandatangan bimbingan Kerja Praktik oleh Dosen Pembimbing', 'C9KVDo605rL0YjiG4f5e419938QnZmIJ63aFT1Rlv2NG5817BJsAqWHA2MlK2Y1u7SkX7CTLREt60wyjU8Ur4hc28QOVgfN56Wu4', '2022-07-04 07:22:47', 'Dr. ARBI HAZA NASUTION  B.IT(Hons).  M.IT.', 'Dosen Pembimbing Kerja Praktik', 'Tandatangan bimbingan Kerja praktik atas nama Fitri Safnita (183510400) pertemuan ke-2', 'Tervalidasi', 'Tersedia'),
(526, 338, 'Tandatangan bimbingan Kerja Praktik oleh Dosen Pembimbing', '5Rha5jIkD2r7M8rA01EtV6oKBD32z6qui94g8lBLPC94x27NHXsip05EHe2sFImSGKCnfyXb3YO37LWmScZb5wJhydAvTNdf98Pv', '2022-07-04 07:23:12', 'Dr. ARBI HAZA NASUTION  B.IT(Hons).  M.IT.', 'Dosen Pembimbing Kerja Praktik', 'Tandatangan bimbingan Kerja praktik atas nama Fitri Safnita (183510400) pertemuan ke-3', 'Tervalidasi', 'Tersedia'),
(527, 231, 'Tandatangan kartu bimbingan Kerja Praktik oleh Prodi', '1yiXM4K8yuAOHJrY2P1WR5ZXbvwZkLhD4DtqfcsjTagu6xIQ4vdq1dgj37lH0B7NC8UYn09Em3f215Ipro24E597QhFBVeRlGw6T', '2022-07-04 08:48:44', 'Dr. Apri Siswanto S.Kom M.Kom', 'Ketua Program Studi', 'Tandatangan Kartu Bimbingan Kerja Praktik oleh Dr. Apri Siswanto S.Kom M.Kom', 'Tervalidasi', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_ttd_surat`
--
...
--
-- Dumping data for table `tbl_ttd_surat`
--

INSERT INTO `tbl_ttd_surat` (`id_ttd_surat`, `id_relasi`, `topik_relasi`, `id_random`, `waktu_input_ttd`, `nama_penanda_tangan`, `npk_penanda_tangan`, `jabatan_penanda_tangan`, `nomor_surat`, `perihal`, `status_validasi`, `status`) VALUES
(483, 253, 'Tandatangan Surat Pengantar Instansi KP oleh Dekan', '3OL1egT342IzQjvyA3Kd0F6do17M5ZnZiBSam6J0xscvDXSffksBR90MhL29t84pQFDzigUrUY18G0NxXPI3YTVoG56l1H5u5t9h', '2022-04-26 11:32:52', 'Dr. Eng. Muslim.MT', '09110237\n', 'Dekan', '0001/E-UIR/27-T/2022', 'Tandatangan Surat Pengantar Instansi KP ke UIR di Jl. Kaharuddin atas nama Nadia Rozaan (183510393) yang diajukan pada tanggal 2022-04-26 11:30:34 dan berlangsung pada 2022-04-08sampai dengan 2022-04-29.', 'Tervalidasi', 'Tersedia'),
(484, 255, 'Tandatangan Surat Pengantar Instansi KP oleh Dekan', 'P5goo63zf23zi1cAlWLUVa9TEp9176hWrjs6a30XVQgAqXF51EDCes4dC4mH9qNLFJt3Si1nIkBR8uOwSmnPxY70jO5hpKevM0YG', '2022-05-30 22:45:09', 'Dr. Eng. Muslim.MT', '09110237\n', 'Dekan', '0002/E-UIR/27-T/2022', 'Tandatangan Surat Pengantar Instansi KP ke das di dsa atas nama Fitri Safnita (183510400) yang diajukan pada tanggal 2022-05-30 22:44:30 dan berlangsung pada 2022-05-13sampai dengan 2022-05-25.', 'Tervalidasi', 'Tersedia'),
(485, 52, 'Tandatangan Surat Pengantar Permohonan Penelitian oleh Dekan', '8wxJ8sW4t9YAFefZoJar5f030ENvcwkyzR1Zsv09HUKK65qL87PD32aGgBg3Y96pzVtlEdHj7T56IQ4A62hXDiM9OxSy8RhXdcC2', '2022-06-06 11:45:54', 'Dr. Eng. Muslim.MT', '09110237\n', 'Dekan', '0001/KPTS/FT-UIR/SP/2022', 'Tandatangan Surat Pengantar Permohonan Penelitian di fw di fq atas nama Fitri Safnita (183510400) yang diajukan pada tanggal 2022-06-06 11:45:18.', 'Tervalidasi', 'Tersedia'),
(486, 256, 'Tandatangan Surat Pengantar Instansi KP oleh Dekan', '7rS9oz0J0a8LX9Zjh0DvC2VOUpuTmSibwFUIW3y9PcBHx6RGk70kel3ZVqiXC1DNs45Lp1t3Q57EI8evul2f61YJMxbd2t9q14jc', '2022-06-23 10:54:34', 'Dr. Eng. Muslim.MT', '09110237\n', 'Dekan', '0003/E-UIR/27-T/2022', 'Tandatangan Surat Pengantar Instansi KP ke uir di jl. kaharuddin atas nama Iqbal Maulana (173110270) yang diajukan pada tanggal 2022-06-23 10:53:36 dan berlangsung pada 2022-06-01sampai dengan 2022-07-01.', 'Tervalidasi', 'Tersedia'),
(487, 231, 'Tandatangan SK Pembimbing KP oleh Dekan', '8uQ0IL2G3VYAy0eiH5O7lvsqyO1Qg4JkD3RBu03713o6SmKF9wn9Rb5AE0svEWjM8kGt9DMJ181STg46nxZfCpNlwzLVrZFj78c2', '2022-07-04 14:20:28', 'Dr. Eng. Muslim.MT', '09110237\n', 'Dekan', '0001/KPTS/FT-UIR/KP/2022', 'Tandatangan SK KP atas nama Fitri Safnita (183510400) yang diajukan pada tanggal  dan berlangsung pada 2022-06-23 sampai dengan 2022-06-03.', 'Tervalidasi', 'Tersedia');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_usulan_pembimbing`
--
...
--
-- Table structure for table `tb_berkas_pertemuan`
--
...
--
-- Dumping data for table `tb_berkas_pertemuan`
--
...
--
-- Table structure for table `tb_berkas_ujian_kelas`
--
...
--
-- Dumping data for table `tb_berkas_ujian_kelas`
--
...
('50009088102', 'Dosen', 'NESI SYAFITRI  S.Kom.  M.Cs.', 'Perempuan', 'nesisyafitri@eng.uir.ac.id', '5', 'Lektor', 'S2', 'Dosen Tetap Program Studi', '$2y$10$yhyNpecrqOZbiRRa9sGKv.gBJ/StqLqRvpN27h1IBhT55ABWrTKhu', '', 'Aktif'),
...
('51017049002', 'Dosen', 'RIZDQI AKBAR RAMADHAN  S.Kom.  M.Kom.', 'Laki-laki', '', '5', 'Asisten Ahli', 'S2', 'Dosen Tetap Program Studi', '$2y$10$yhyNpecrqOZbiRRa9sGKv.gBJ/StqLqRvpN27h1IBhT55ABWrTKhu', '1701202206494712410589_10205091292753473_7780528969235457718_n.jpg', 'Aktif'),
...
('51031126801', 'Dosen', 'AKMAR EFENDI  S.Kom.  M.Kom.', 'Laki-laki', '', '5', 'Lektor', 'S2', 'Dosen Tetap Program Studi', '$2y$10$yhyNpecrqOZbiRRa9sGKv.gBJ/StqLqRvpN27h1IBhT55ABWrTKhu', '20092021012152Foto.JPG', 'Aktif'),
...
--
-- Table structure for table `tb_dosen_lanjutan`
--
...
--
-- Dumping data for table `tb_dosen_lanjutan`
--
...
--
-- Table structure for table `tb_jadwal_kelas_pertemuan`
--
...
--
-- Dumping data for table `tb_jadwal_kelas_pertemuan`
--
...
--
-- Table structure for table `tb_jadwal_libur_pertemuan`
--
...
--
-- Dumping data for table `tb_jadwal_libur_pertemuan`
--
...
--
-- Table structure for table `tb_jadwal_pengampu`
--
...
--
-- Dumping data for table `tb_jadwal_pengampu`
--
...
--
-- Table structure for table `tb_jadwal_ujian_lanjutan`
--
...
--
-- Dumping data for table `tb_jadwal_ujian_lanjutan`
--
...
INSERT INTO `tb_kerjasama` (`id_kerjasama`, `jenis_kerjasama`, `tgl_kerjasama`, `lembaga_mitra`, `alamat_mitra`, `negara`, `provinsi`, `kota_kab`, `durasi_kerjasama`, `akhir_kerjasama`, `dokumen_kerjasama`) VALUES
(13, 'MOA', '2022-03-14', 'PT. Pertamina Persero', '2424', 'Indonesia', '13', '203', 2, '2024-03-14', 'pepek-14032022100818.pdf'),
(14, 'MOA', '2022-06-08', 'PT. Pertamina Persero', '2424', 'Indonesia', '8', '280', 7, '2024-06-08', 'pepek-11062022040120.pdf');
...
(1512, '183510393', 'Mahasiswa', '2022-04-19 20:15:05', 'Login', 'Login berhasil', 'Tersedia'),
(1513, 'tu', 'Tata Usaha', '2022-04-19 20:15:35', 'Login', 'Login berhasil', 'Tersedia'),
(1514, 'superadmin35', 'Prodi', '2022-04-19 20:15:43', 'Login', 'Login berhasil', 'Tersedia'),
(1515, 'dekan', 'Fakultas', '2022-04-19 20:15:46', 'Login', 'Login berhasil', 'Tersedia'),
(1516, '51018088102', 'Dosen', '2022-04-19 20:20:21', 'Login', 'Login berhasil', 'Tersedia'),
(1517, 'nadiarozaan18@gmail.com', 'Pembimbing Lapangan KP', '2022-04-19 20:23:34', 'Login', 'Login berhasil', 'Tersedia'),
(1518, 'koordinator35', 'Koordinator Prodi', '2022-04-19 20:26:55', 'Login', 'Login berhasil', 'Tersedia'),
(1519, '50009088102', 'Dosen', '2022-04-19 20:34:35', 'Login', 'Login berhasil', 'Tersedia'),
(1520, '51026126801', 'Dosen', '2022-04-19 20:35:06', 'Login', 'Login berhasil', 'Tersedia'),
(1521, '51031126801', 'Dosen', '2022-04-19 20:36:30', 'Login', 'Login berhasil', 'Tersedia'),
(1522, 'tu', 'Tata Usaha', '2022-04-19 20:43:09', 'Login', 'Login berhasil', 'Tersedia'),
(1523, 'superadmin35', 'Prodi', '2022-04-22 18:48:52', 'Login', 'Login berhasil', 'Tersedia'),
(1524, '183510400', 'Mahasiswa', '2022-04-22 18:49:32', 'Login', 'Login berhasil', 'Tersedia'),
(1525, 'tu', 'Tata Usaha', '2022-04-22 18:50:22', 'Login', 'Login berhasil', 'Tersedia'),
(1526, 'dekan', 'Fakultas', '2022-04-22 18:50:46', 'Login', 'Login berhasil', 'Tersedia'),
(1527, '51018088102', 'Dosen', '2022-04-22 18:56:42', 'Login', 'Login berhasil', 'Tersedia'),
(1528, 'a@gmail.com', 'Pembimbing Lapangan KP', '2022-04-22 19:04:12', 'Login', 'Login berhasil', 'Tersedia'),
(1529, '183510417', 'Mahasiswa', '2022-04-22 19:44:36', 'Login', 'Login berhasil', 'Tersedia'),
(1530, 'dekan', 'Fakultas', '2022-04-22 20:50:40', 'Login', 'Login berhasil', 'Tersedia'),
(1531, '51018088102', 'Dosen', '2022-04-22 20:51:32', 'Login', 'Login berhasil', 'Tersedia'),
(1532, '183510417', 'Mahasiswa', '2022-04-22 20:52:30', 'Login', 'Login berhasil', 'Tersedia'),
(1533, 'superadmin35', 'Prodi', '2022-04-22 21:53:42', 'Login', 'Login berhasil', 'Tersedia'),
(1534, '183510720', 'Mahasiswa', '2022-04-22 22:00:04', 'Login', 'Login berhasil', 'Tersedia'),
(1535, 'tu', 'Tata Usaha', '2022-04-22 22:00:49', 'Login', 'Login berhasil', 'Tersedia'),
(1536, 'dekan', 'Fakultas', '2022-04-22 22:01:50', 'Login', 'Login berhasil', 'Tersedia'),
(1537, '183510720', 'Mahasiswa', '2022-04-22 22:05:06', 'Login', 'Login berhasil', 'Tersedia'),
(1538, '51018088102', 'Dosen', '2022-04-22 22:06:18', 'Login', 'Login berhasil', 'Tersedia'),
(1539, '183510417', 'Mahasiswa', '2022-04-22 22:07:56', 'Login', 'Login berhasil', 'Tersedia'),
(1540, '193510261', 'Mahasiswa', '2022-04-22 22:18:55', 'Login', 'Login berhasil', 'Tersedia'),
(1541, 'tes@gmail.com', 'Pembimbing Lapangan KP', '2022-04-22 23:25:12', 'Login', 'Login berhasil', 'Tersedia'),
(1542, 'tu', 'Tata Usaha', '2022-04-23 12:51:29', 'Login', 'Login berhasil', 'Tersedia'),
(1543, 'superadmin35', 'Prodi', '2022-04-23 12:51:36', 'Login', 'Login berhasil', 'Tersedia'),
(1544, 'dekan', 'Fakultas', '2022-04-23 12:51:42', 'Login', 'Login berhasil', 'Tersedia'),
(1545, '51018088102', 'Dosen', '2022-04-23 12:52:35', 'Login', 'Login berhasil', 'Tersedia'),
(1546, '193510261', 'Mahasiswa', '2022-04-23 12:54:53', 'Login', 'Login berhasil', 'Tersedia'),
(1547, '183510393', 'Mahasiswa', '2022-04-23 13:07:08', 'Login', 'Login berhasil', 'Tersedia'),
(1548, '183510393', 'Mahasiswa', '2022-04-23 13:53:25', 'Login', 'Login berhasil', 'Tersedia'),
(1549, 'tu', 'Tata Usaha', '2022-04-23 14:16:18', 'Login', 'Login berhasil', 'Tersedia'),
(1550, 'superadmin35', 'Prodi', '2022-04-23 14:16:26', 'Login', 'Login berhasil', 'Tersedia'),
(1551, 'dekan', 'Fakultas', '2022-04-23 14:16:30', 'Login', 'Login berhasil', 'Tersedia'),
(1552, '183510417', 'Mahasiswa', '2022-04-23 14:19:51', 'Login', 'Login berhasil', 'Tersedia'),
(1553, 'koordinator35', 'Koordinator Prodi', '2022-04-23 14:41:17', 'Login', 'Login berhasil', 'Tersedia'),
(1554, '51023048901', 'Dosen', '2022-04-23 15:05:49', 'Login', 'Login berhasil', 'Tersedia'),
(1555, 'koordinator35', 'Koordinator Prodi', '2022-04-23 15:17:34', 'Login', 'Login berhasil', 'Tersedia'),
(1556, 'superadmin35', 'Prodi', '2022-04-23 21:40:24', 'Login', 'Login berhasil', 'Tersedia'),
(1557, 'koordinator35', 'Koordinator Prodi', '2022-04-23 21:41:37', 'Login', 'Login berhasil', 'Tersedia'),
(1558, '183510400', 'Mahasiswa', '2022-04-23 21:42:29', 'Login', 'Login berhasil', 'Tersedia'),
(1559, 'tu', 'Tata Usaha', '2022-04-23 22:08:16', 'Login', 'Login berhasil', 'Tersedia'),
(1560, 'dekan', 'Fakultas', '2022-04-23 22:08:33', 'Login', 'Login berhasil', 'Tersedia'),
(1561, 'superadmin35', 'Prodi', '2022-04-23 22:08:39', 'Login', 'Login berhasil', 'Tersedia'),
(1562, '183510400', 'Mahasiswa', '2022-04-23 22:09:22', 'Login', 'Login berhasil', 'Tersedia'),
(1563, '51023048901', 'Dosen', '2022-04-23 22:11:26', 'Login', 'Login berhasil', 'Tersedia'),
(1564, 'koordinator35', 'Koordinator Prodi', '2022-04-23 22:12:01', 'Login', 'Login berhasil', 'Tersedia'),
(1565, '50314068701', 'Dosen', '2022-04-23 22:36:40', 'Login', 'Login berhasil', 'Tersedia'),
(1566, '183510400', 'Mahasiswa', '2022-04-23 23:26:39', 'Login', 'Login berhasil', 'Tersedia'),
(1567, '51029027601', 'Dosen', '2022-04-23 23:37:17', 'Login', 'Login berhasil', 'Tersedia'),
(1568, '51023048901', 'Dosen', '2022-04-24 00:00:37', 'Login', 'Login berhasil', 'Tersedia'),
(1569, 'dekan', 'Fakultas', '2022-04-24 00:00:56', 'Login', 'Login berhasil', 'Tersedia'),
(1570, '51029027601', 'Dosen', '2022-04-24 00:13:58', 'Login', 'Login berhasil', 'Tersedia'),
(1571, '183510400', 'Mahasiswa', '2022-04-24 00:16:37', 'Login', 'Login berhasil', 'Tersedia'),
(1572, 'tu', 'Tata Usaha', '2022-04-24 00:52:53', 'Login', 'Login berhasil', 'Tersedia'),
(1573, '51029027601', 'Dosen', '2022-04-24 00:54:31', 'Login', 'Login berhasil', 'Tersedia'),
(1574, '50314068701', 'Dosen', '2022-04-24 00:54:56', 'Login', 'Login berhasil', 'Tersedia'),
(1575, '183510400', 'Mahasiswa', '2022-04-24 11:54:59', 'Login', 'Login berhasil', 'Tersedia'),
(1576, 'tu', 'Tata Usaha', '2022-04-24 11:55:39', 'Login', 'Login berhasil', 'Tersedia'),
(1577, 'superadmin35', 'Prodi', '2022-04-24 11:56:54', 'Login', 'Login berhasil', 'Tersedia'),
(1578, 'dekan', 'Fakultas', '2022-04-24 11:58:47', 'Login', 'Login berhasil', 'Tersedia'),
(1579, '51023048901', 'Dosen', '2022-04-24 12:02:59', 'Login', 'Login berhasil', 'Tersedia'),
(1580, 'tes@gmail.com', 'Pembimbing Lapangan KP', '2022-04-24 12:05:17', 'Login', 'Login berhasil', 'Tersedia'),
(1581, 'koordinator35', 'Koordinator Prodi', '2022-04-24 12:09:45', 'Login', 'Login berhasil', 'Tersedia'),
(1582, '51029027601', 'Dosen', '2022-04-24 12:14:33', 'Login', 'Login berhasil', 'Tersedia'),
(1583, 'koordinator35', 'Koordinator Prodi', '2022-04-24 12:15:38', 'Login', 'Login berhasil', 'Tersedia'),
(1584, '50314068701', 'Dosen', '2022-04-24 12:16:08', 'Login', 'Login berhasil', 'Tersedia'),
(1585, '51024077901', 'Dosen', '2022-04-24 12:24:50', 'Login', 'Login berhasil', 'Tersedia'),
(1586, '51029027601', 'Dosen', '2022-04-24 12:25:20', 'Login', 'Login berhasil', 'Tersedia'),
(1587, 'tu', 'Tata Usaha', '2022-04-24 12:37:50', 'Login', 'Login berhasil', 'Tersedia'),
(1588, 'upm', 'UPM', '2022-04-24 12:40:42', 'Login', 'Login berhasil', 'Tersedia'),
(1589, 'dekan', 'Fakultas', '2022-04-24 12:53:05', 'Login', 'Login berhasil', 'Tersedia'),
(1590, '51023048901', 'Dosen', '2022-04-24 13:01:35', 'Login', 'Login berhasil', 'Tersedia'),
(1591, 'koordinator35', 'Koordinator Prodi', '2022-04-24 14:09:57', 'Login', 'Login berhasil', 'Tersedia'),
(1592, 'gkm35', 'GKM Prodi', '2022-04-24 14:16:08', 'Login', 'Login berhasil', 'Tersedia'),
(1593, 'gkm31', 'GKM Prodi', '2022-04-24 14:19:49', 'Login', 'Login berhasil', 'Tersedia'),
(1594, 'superadmin35', 'Prodi', '2022-04-24 14:20:15', 'Login', 'Login berhasil', 'Tersedia'),
(1595, 'superadmin31', 'Prodi', '2022-04-24 14:20:26', 'Login', 'Login berhasil', 'Tersedia'),
(1596, 'tu', 'Tata Usaha', '2022-04-25 10:12:03', 'Login', 'Login berhasil', 'Tersedia'),
(1597, '193510261', 'Mahasiswa', '2022-04-25 10:13:17', 'Login', 'Login berhasil', 'Tersedia'),
(1598, 'superadmin35', 'Prodi', '2022-04-25 10:13:24', 'Login', 'Login berhasil', 'Tersedia'),
(1599, 'dekan', 'Fakultas', '2022-04-25 10:13:29', 'Login', 'Login berhasil', 'Tersedia'),
(1600, '51024077901', 'Dosen', '2022-04-25 10:23:36', 'Login', 'Login berhasil', 'Tersedia'),
(1601, 'tes@gmail.com', 'Pembimbing Lapangan KP', '2022-04-25 10:32:41', 'Login', 'Login berhasil', 'Tersedia'),
(1602, 'koordinator35', 'Koordinator Prodi', '2022-04-25 10:49:57', 'Login', 'Login berhasil', 'Tersedia'),
(1603, '50009088102', 'Dosen', '2022-04-25 10:51:52', 'Login', 'Login berhasil', 'Tersedia'),
(1604, '51017049002', 'Dosen', '2022-04-25 10:53:21', 'Login', 'Login berhasil', 'Tersedia'),
(1605, 'dekan', 'Fakultas', '2022-04-25 10:53:41', 'Login', 'Login berhasil', 'Tersedia'),
(1606, '50009088102', 'Dosen', '2022-04-25 10:57:35', 'Login', 'Login berhasil', 'Tersedia'),
(1607, '51024077901', 'Dosen', '2022-04-25 10:58:02', 'Login', 'Login berhasil', 'Tersedia'),
(1608, '51029027601', 'Dosen', '2022-04-25 10:58:45', 'Login', 'Login berhasil', 'Tersedia'),
(1609, '51015047503', 'Dosen', '2022-04-25 10:59:22', 'Login', 'Login berhasil', 'Tersedia'),
(1610, 'tu', 'Tata Usaha', '2022-04-25 11:03:21', 'Login', 'Login berhasil', 'Tersedia'),
(1611, 'dekan', 'Fakultas', '2022-04-25 13:03:30', 'Login', 'Login berhasil', 'Tersedia'),
(1612, 'superadmin35', 'Prodi', '2022-04-25 13:03:42', 'Login', 'Login berhasil', 'Tersedia'),
(1613, 'tu', 'Tata Usaha', '2022-04-25 13:03:51', 'Login', 'Login berhasil', 'Tersedia'),
(1614, 'dekan', 'Fakultas', '2022-04-25 23:03:16', 'Login', 'Login berhasil', 'Tersedia'),
(1615, 'superadmin35', 'Prodi', '2022-04-25 23:03:26', 'Login', 'Login berhasil', 'Tersedia'),
(1616, 'tu', 'Tata Usaha', '2022-04-25 23:03:30', 'Login', 'Login berhasil', 'Tersedia'),
(1617, '193510261', 'Mahasiswa', '2022-04-25 23:12:27', 'Login', 'Login berhasil', 'Tersedia'),
(1618, '193510261', 'Mahasiswa', '2022-04-26 04:15:07', 'Login', 'Login berhasil', 'Tersedia'),
(1619, 'tu', 'Tata Usaha', '2022-04-26 04:15:14', 'Login', 'Login berhasil', 'Tersedia'),
(1620, 'dekan', 'Fakultas', '2022-04-26 04:30:04', 'Login', 'Login berhasil', 'Tersedia'),
(1621, '183510393', 'Mahasiswa', '2022-04-26 11:20:04', 'Login', 'Login berhasil', 'Tersedia'),
(1622, '183510393', 'Mahasiswa', '2022-04-26 11:21:22', 'Login', 'Login berhasil', 'Tersedia'),
(1623, 'tu', 'Tata Usaha', '2022-04-26 11:25:23', 'Login', 'Login berhasil', 'Tersedia'),
(1624, 'superadmin35', 'Prodi', '2022-04-26 11:28:33', 'Login', 'Login berhasil', 'Tersedia'),
(1625, 'dekan', 'Fakultas', '2022-04-26 11:31:30', 'Login', 'Login berhasil', 'Tersedia'),
(1626, '183510393', 'Mahasiswa', '2022-04-28 22:13:20', 'Login', 'Login berhasil', 'Tersedia');
INSERT INTO `tb_log` (`id_log`, `username`, `status_login`, `waktu_log`, `aktifitas`, `aktifitas_detail`, `status`) VALUES
(1627, 'superadmin35', 'Prodi', '2022-04-28 22:33:49', 'Login', 'Login berhasil', 'Tersedia'),
(1628, 'superadmin35', 'Prodi', '2022-05-06 11:32:12', 'Login', 'Login berhasil', 'Tersedia'),
(1629, 'superadmin35', 'Prodi', '2022-05-06 11:34:03', 'Login', 'Login berhasil', 'Tersedia'),
(1630, '183510393', 'Mahasiswa', '2022-05-13 11:03:02', 'Login', 'Login berhasil', 'Tersedia'),
(1631, 'superadmin35', 'Prodi', '2022-05-20 09:55:53', 'Login', 'Login berhasil', 'Tersedia'),
(1632, '183510393', 'Mahasiswa', '2022-05-20 09:57:45', 'Login', 'Login berhasil', 'Tersedia'),
(1633, 'tu', 'Tata Usaha', '2022-05-23 14:43:05', 'Login', 'Login berhasil', 'Tersedia'),
(1634, '183510393', 'Mahasiswa', '2022-05-23 15:03:53', 'Login', 'Login berhasil', 'Tersedia'),
(1635, 'tu', 'Tata Usaha', '2022-05-24 09:27:03', 'Login', 'Login berhasil', 'Tersedia'),
(1636, '183510393', 'Mahasiswa', '2022-05-24 09:27:41', 'Login', 'Login berhasil', 'Tersedia'),
(1637, '183510393', 'Mahasiswa', '2022-05-24 10:17:18', 'Login', 'Login berhasil', 'Tersedia'),
(1638, 'tu', 'Tata Usaha', '2022-05-24 10:17:43', 'Login', 'Login berhasil', 'Tersedia'),
(1639, 'superadmin35', 'Prodi', '2022-05-24 10:20:53', 'Login', 'Login berhasil', 'Tersedia'),
(1640, 'tu', 'Tata Usaha', '2022-05-24 12:49:09', 'Login', 'Login berhasil', 'Tersedia'),
(1641, 'superadmin35', 'Prodi', '2022-05-24 12:49:35', 'Login', 'Login berhasil', 'Tersedia'),
(1642, 'superadmin35', 'Prodi', '2022-05-30 22:43:20', 'Login', 'Login berhasil', 'Tersedia'),
(1643, '183510400', 'Mahasiswa', '2022-05-30 22:43:58', 'Login', 'Login berhasil', 'Tersedia'),
(1644, 'tu', 'Tata Usaha', '2022-05-30 22:44:40', 'Login', 'Login berhasil', 'Tersedia'),
(1645, 'dekan', 'Fakultas', '2022-05-30 22:45:01', 'Login', 'Login berhasil', 'Tersedia'),
(1646, 'tu', 'Tata Usaha', '2022-05-31 13:37:11', 'Login', 'Login berhasil', 'Tersedia'),
(1647, 'tu', 'Tata Usaha', '2022-06-01 20:42:34', 'Login', 'Login berhasil', 'Tersedia'),
(1648, '183510400', 'Mahasiswa', '2022-06-01 20:42:44', 'Login', 'Login berhasil', 'Tersedia'),
(1649, '183510400', 'Mahasiswa', '2022-06-01 22:14:20', 'Login', 'Login berhasil', 'Tersedia'),
(1650, '183510400', 'Mahasiswa', '2022-06-02 11:08:24', 'Login', 'Login berhasil', 'Tersedia'),
(1651, 'tu', 'Tata Usaha', '2022-06-02 11:12:09', 'Login', 'Login berhasil', 'Tersedia'),
(1652, 'tu', 'Tata Usaha', '2022-06-03 14:14:08', 'Login', 'Login berhasil', 'Tersedia'),
(1653, 'tu', 'Tata Usaha', '2022-06-06 11:44:17', 'Login', 'Login berhasil', 'Tersedia'),
(1654, '183510400', 'Mahasiswa', '2022-06-06 11:44:56', 'Login', 'Login berhasil', 'Tersedia'),
(1655, 'superadmin35', 'Prodi', '2022-06-06 11:45:31', 'Login', 'Login berhasil', 'Tersedia'),
(1656, 'dekan', 'Fakultas', '2022-06-06 11:45:45', 'Login', 'Login berhasil', 'Tersedia'),
(1657, 'superadmin35', 'Prodi', '2022-06-07 09:33:26', 'Login', 'Login berhasil', 'Tersedia'),
(1658, 'superadmin35', 'Prodi', '2022-06-07 11:38:19', 'Login', 'Login berhasil', 'Tersedia'),
(1659, '183510400', 'Mahasiswa', '2022-06-07 12:17:06', 'Login', 'Login berhasil', 'Tersedia'),
(1660, 'tu', 'Tata Usaha', '2022-06-07 12:25:29', 'Login', 'Login berhasil', 'Tersedia'),
(1661, '183510417', 'Mahasiswa', '2022-06-16 15:39:17', 'Login', 'Login berhasil', 'Tersedia'),
(1662, 'tu', 'Tata Usaha', '2022-06-16 15:40:03', 'Login', 'Login berhasil', 'Tersedia'),
(1663, '183510400', 'Mahasiswa', '2022-06-16 15:45:43', 'Login', 'Login berhasil', 'Tersedia'),
(1664, '183510400', 'Mahasiswa', '2022-06-20 09:11:07', 'Login', 'Login berhasil', 'Tersedia'),
(1665, 'tu', 'Tata Usaha', '2022-06-20 09:11:12', 'Login', 'Login berhasil', 'Tersedia'),
(1666, 'superadmin35', 'Prodi', '2022-06-20 09:29:34', 'Login', 'Login berhasil', 'Tersedia'),
(1667, 'tu', 'Tata Usaha', '2022-06-22 20:52:56', 'Login', 'Login berhasil', 'Tersedia'),
(1668, '183510400', 'Mahasiswa', '2022-06-22 20:54:31', 'Login', 'Login berhasil', 'Tersedia'),
(1669, 'nadiarozaan@student.uir.ac.id', 'Pembimbing Lapangan KP', '2022-06-22 21:48:01', 'Login', 'Login berhasil', 'Tersedia'),
(1670, 'tu', 'Tata Usaha', '2022-06-23 10:51:10', 'Login', 'Login berhasil', 'Tersedia'),
(1671, 'dekan', 'Fakultas', '2022-06-23 10:51:31', 'Login', 'Login berhasil', 'Tersedia'),
(1672, 'superadmin31', 'Prodi', '2022-06-23 10:51:47', 'Login', 'Login berhasil', 'Tersedia'),
(1673, '173110270', 'Mahasiswa', '2022-06-23 10:52:40', 'Login', 'Login berhasil', 'Tersedia'),
(1674, '173110270', 'Mahasiswa', '2022-06-23 11:10:15', 'Login', 'Login berhasil', 'Tersedia'),
(1675, 'tu', 'Tata Usaha', '2022-06-23 11:13:11', 'Login', 'Login berhasil', 'Tersedia'),
(1676, 'superadmin31', 'Prodi', '2022-06-23 11:13:40', 'Login', 'Login berhasil', 'Tersedia'),
(1677, 'tu', 'Tata Usaha', '2022-06-28 11:02:27', 'Login', 'Login berhasil', 'Tersedia'),
(1678, 'superadmin35', 'Prodi', '2022-06-28 11:02:45', 'Login', 'Login berhasil', 'Tersedia'),
(1679, 'nadiarozaan@student.uir.ac.id', 'Pembimbing Lapangan KP', '2022-06-28 17:34:24', 'Login', 'Login berhasil', 'Tersedia'),
(1680, 'nadiarozaan@student.uir.ac.id', 'Pembimbing Lapangan KP', '2022-06-28 17:39:13', 'Login', 'Login berhasil', 'Tersedia'),
(1681, 'superadmin35', 'Prodi', '2022-06-28 17:40:26', 'Login', 'Login berhasil', 'Tersedia'),
(1682, 'superadmin31', 'Prodi', '2022-06-28 17:41:54', 'Login', 'Login berhasil', 'Tersedia'),
(1683, 'tu', 'Tata Usaha', '2022-06-28 17:43:56', 'Login', 'Login berhasil', 'Tersedia'),
(1684, 'tu', 'Tata Usaha', '2022-06-29 13:20:04', 'Login', 'Login berhasil', 'Tersedia'),
(1685, 'tu', 'Tata Usaha', '2022-06-29 14:14:52', 'Login', 'Login berhasil', 'Tersedia'),
(1686, '173110270', 'Mahasiswa', '2022-06-29 14:18:51', 'Login', 'Login berhasil', 'Tersedia'),
(1687, 'tu', 'Tata Usaha', '2022-06-29 15:15:26', 'Login', 'Login berhasil', 'Tersedia'),
(1688, 'tu', 'Tata Usaha', '2022-06-30 10:50:05', 'Login', 'Login berhasil', 'Tersedia'),
(1689, 'dekan', 'Fakultas', '2022-06-30 11:00:12', 'Login', 'Login berhasil', 'Tersedia'),
(1690, 'superadmin35', 'Prodi', '2022-06-30 11:00:25', 'Login', 'Login berhasil', 'Tersedia'),
(1691, '183510400', 'Mahasiswa', '2022-06-30 11:00:47', 'Login', 'Login berhasil', 'Tersedia'),
(1692, 'dekan', 'Fakultas', '2022-06-30 12:59:10', 'Login', 'Login berhasil', 'Tersedia'),
(1693, '10008076401', 'Dosen', '2022-06-30 14:18:00', 'Login', 'Login berhasil', 'Tersedia'),
(1694, 'tu', 'Tata Usaha', '2022-07-04 13:53:37', 'Login', 'Login berhasil', 'Tersedia'),
(1695, 'superadmin35', 'Prodi', '2022-07-04 13:54:02', 'Login', 'Login berhasil', 'Tersedia'),
(1696, '183510400', 'Mahasiswa', '2022-07-04 13:54:17', 'Login', 'Login berhasil', 'Tersedia'),
(1697, 'superadmin31', 'Prodi', '2022-07-04 14:11:01', 'Login', 'Login berhasil', 'Tersedia'),
(1698, 'tu', 'Tata Usaha', '2022-07-04 14:11:29', 'Login', 'Login berhasil', 'Tersedia'),
(1699, 'superadmin35', 'Prodi', '2022-07-04 14:11:57', 'Login', 'Login berhasil', 'Tersedia'),
(1700, 'fitrisafnita@student.uir.ac.id', 'Pembimbing Lapangan KP', '2022-07-04 14:17:19', 'Login', 'Login berhasil', 'Tersedia'),
(1701, 'dekan', 'Fakultas', '2022-07-04 14:19:56', 'Login', 'Login berhasil', 'Tersedia'),
(1702, '51023048901', 'Dosen', '2022-07-04 14:21:34', 'Login', 'Login berhasil', 'Tersedia'),
(1703, '173110270', 'Mahasiswa', '2022-07-04 17:20:58', 'Login', 'Login berhasil', 'Tersedia'),
(1704, 'tu', 'Tata Usaha', '2022-07-05 08:59:46', 'Login', 'Login berhasil', 'Tersedia'),
(1705, '183510400', 'Mahasiswa', '2022-07-05 09:00:19', 'Login', 'Login berhasil', 'Tersedia'),
(1706, 'tu', 'Tata Usaha', '2022-07-16 15:27:17', 'Login', 'Login berhasil', 'Tersedia');
...
--
-- Table structure for table `tb_presensi_pertemuan`
--
...
--
-- Dumping data for table `tb_presensi_pertemuan`
--
...
--
-- Table structure for table `tb_prodi_attribut`
--
...
--
-- Dumping data for table `tb_prodi_attribut`
--
...
--
-- Table structure for table `tb_request_pertemuan`
--
...
--
-- Dumping data for table `tb_request_pertemuan`
--
...
--
-- Table structure for table `tb_surat_keputusan`
--
...
--
-- Dumping data for table `tb_surat_keputusan`
--
...
--
-- Table structure for table `tb_ttd_digital`
--
...
--
-- Dumping data for table `tb_ttd_digital`
--
...
--
-- Table structure for table `tb_tugas_pengampu`
--
...
--
-- Dumping data for table `tb_tugas_pengampu`
--
...
--
-- Table structure for table `tb_upm`
--
...
--
-- Indexes for table `tbl_bimbingan_skripsi`
--
...
--
-- Indexes for table `tb_dosen_lanjutan`
--
...
--
-- Indexes for table `tb_jadwal_ujian_lanjutan`
--
...
--
-- Indexes for table `tb_presensi_pertemuan`
--
...
--
-- Indexes for table `tb_prodi_attribut`
--
ALTER TABLE `tb_prodi_attribut`
  ADD PRIMARY KEY (`username`);

--
-- Indexes for table `tb_request_pertemuan`
--
...
--
-- Indexes for table `tb_surat_keputusan`
--
...
--
-- Indexes for table `tb_ttd_digital`
--
...
--
-- Indexes for table `tb_tugas_pengampu`
--
...
--
ALTER TABLE `tbl_bimbingan`
  MODIFY `id_bimbingan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=339;

--
-- AUTO_INCREMENT for table `tbl_bimbingan_skripsi`
--
ALTER TABLE `tbl_bimbingan_skripsi`
  MODIFY `id_bimbingan_skripsi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;

--
-- AUTO_INCREMENT for table `tbl_dospem`
--
ALTER TABLE `tbl_dospem`
  MODIFY `id_dospem` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;

--
-- AUTO_INCREMENT for table `tbl_dospem_skripsi`
--
ALTER TABLE `tbl_dospem_skripsi`
  MODIFY `id_dospem_skripsi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;

--
-- AUTO_INCREMENT for table `tbl_file_kp`
--
ALTER TABLE `tbl_file_kp`
  MODIFY `id_file_kp` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=261;

--
-- AUTO_INCREMENT for table `tbl_file_skripsi`
--
ALTER TABLE `tbl_file_skripsi`
  MODIFY `id_file_skripsi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=307;

--
-- AUTO_INCREMENT for table `tbl_jenis_sk`
--
ALTER TABLE `tbl_jenis_sk`
...
--
ALTER TABLE `tbl_nilai`
  MODIFY `id_nilai` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT for table `tbl_nilai_kompre`
--
ALTER TABLE `tbl_nilai_kompre`
  MODIFY `id_nilai_kompre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT for table `tbl_nilai_sempro`
--
ALTER TABLE `tbl_nilai_sempro`
  MODIFY `id_nilai_sempro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT for table `tbl_nomor_surat`
--
ALTER TABLE `tbl_nomor_surat`
  MODIFY `id_nomor_surat` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=495;

--
-- AUTO_INCREMENT for table `tbl_open_file`
--
ALTER TABLE `tbl_open_file`
  MODIFY `id_open_file` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=455;

--
-- AUTO_INCREMENT for table `tbl_open_file_kompre`
--
ALTER TABLE `tbl_open_file_kompre`
  MODIFY `id_open_file_kompre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;

--
-- AUTO_INCREMENT for table `tbl_open_file_sempro`
--
ALTER TABLE `tbl_open_file_sempro`
  MODIFY `id_open_file_sempro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT for table `tbl_open_file_skripsi`
--
ALTER TABLE `tbl_open_file_skripsi`
  MODIFY `id_open_file` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=221;

--
-- AUTO_INCREMENT for table `tbl_pembimbing_lapangan`
--
ALTER TABLE `tbl_pembimbing_lapangan`
  MODIFY `id_pembimbing_lapangan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

--
-- AUTO_INCREMENT for table `tbl_penguji_skripsi`
--
ALTER TABLE `tbl_penguji_skripsi`
  MODIFY `id_penguji_skripsi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_kompre`
--
ALTER TABLE `tbl_persetujuan_kompre`
  MODIFY `id_persetujuan_kompre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=204;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_sempro`
--
ALTER TABLE `tbl_persetujuan_sempro`
  MODIFY `id_persetujuan_sempro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=216;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_sk`
--
ALTER TABLE `tbl_persetujuan_sk`
  MODIFY `id_persetujuan_sk` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=931;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_skripsi`
--
ALTER TABLE `tbl_persetujuan_skripsi`
  MODIFY `id_persetujuan_skripsi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=319;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_surat_pengantar`
--
ALTER TABLE `tbl_persetujuan_surat_pengantar`
  MODIFY `id_persetujuan_surat_pengantar` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=314;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_surat_pengantar_penelitian`
--
ALTER TABLE `tbl_persetujuan_surat_pengantar_penelitian`
  MODIFY `id_persetujuan_surat_pengantar_penelitian` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `tbl_persetujuan_usulan_pembimbing`
--
ALTER TABLE `tbl_persetujuan_usulan_pembimbing`
  MODIFY `id_persetujuan_usulan_pembimbing` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `tbl_skripsi`
  MODIFY `id_skripsi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT for table `tbl_surat_pengantar`
--
ALTER TABLE `tbl_surat_pengantar`
  MODIFY `id_surat_pengantar` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=257;

--
-- AUTO_INCREMENT for table `tbl_surat_pengantar_penelitian`
--
ALTER TABLE `tbl_surat_pengantar_penelitian`
  MODIFY `id_surat_pengantar_penelitian` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;

--
-- AUTO_INCREMENT for table `tbl_syarat_kompre`
--
ALTER TABLE `tbl_syarat_kompre`
  MODIFY `id_syarat_kompre` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tbl_syarat_sempro`
--
ALTER TABLE `tbl_syarat_sempro`
  MODIFY `id_syarat_sempro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `tbl_syarat_sk`
--
ALTER TABLE `tbl_syarat_sk`
  MODIFY `id_syarat_sk` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=236;

--
-- AUTO_INCREMENT for table `tbl_ttd_dospem`
--
ALTER TABLE `tbl_ttd_dospem`
  MODIFY `id_ttd_dospem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=528;

--
-- AUTO_INCREMENT for table `tbl_ttd_surat`
--
ALTER TABLE `tbl_ttd_surat`
  MODIFY `id_ttd_surat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=488;

--
-- AUTO_INCREMENT for table `tbl_usulan_pembimbing`
--
ALTER TABLE `tbl_usulan_pembimbing`
  MODIFY `id_usulan_pembimbing` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=196;

--
-- AUTO_INCREMENT for table `tb_berkas_pertemuan`
--
ALTER TABLE `tb_berkas_pertemuan`
  MODIFY `id_berkas_pertemuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `tb_berkas_ujian_kelas`
--
ALTER TABLE `tb_berkas_ujian_kelas`
  MODIFY `id_berkas_ujian_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tb_dosen_lanjutan`
--
ALTER TABLE `tb_dosen_lanjutan`
  MODIFY `id_dosen_lanjutan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;

--
-- AUTO_INCREMENT for table `tb_jadwal_kelas_pertemuan`
--
ALTER TABLE `tb_jadwal_kelas_pertemuan`
  MODIFY `id_jadwal_kelas_pertemuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tb_jadwal_libur_pertemuan`
--
ALTER TABLE `tb_jadwal_libur_pertemuan`
  MODIFY `id_jadwal_libur_pertemuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tb_jadwal_pengampu`
--
ALTER TABLE `tb_jadwal_pengampu`
...
--
-- AUTO_INCREMENT for table `tb_jadwal_ujian_lanjutan`
--
ALTER TABLE `tb_jadwal_ujian_lanjutan`
...
--
ALTER TABLE `tb_log`
  MODIFY `id_log` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1707;
...
--
-- AUTO_INCREMENT for table `tb_presensi_pertemuan`
--
ALTER TABLE `tb_presensi_pertemuan`
  MODIFY `id_presensi_pertemuan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT for table `tb_request_pertemuan`
--
ALTER TABLE `tb_request_pertemuan`
...
--
-- AUTO_INCREMENT for table `tb_surat_keputusan`
--
ALTER TABLE `tb_surat_keputusan`
...
--
-- AUTO_INCREMENT for table `tb_ttd_digital`
--
ALTER TABLE `tb_ttd_digital`
  MODIFY `id_ttd_digital` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT for table `tb_tugas_pengampu`
--
ALTER TABLE `tb_tugas_pengampu`
