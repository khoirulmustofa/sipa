								...
								<div class="col-md-12">
									<div class="card">
										<div class="card-header bg-warning rounded">
											<h2 class="text-white"><blink class="text-white">PENGUMUMAN</blink> <marquee class="text-danger bg-white">Matakuliah yang diampu oleh 2 atau 3 orang dosen, mohon melaporkan tatap muka melalui akun SiPA masing-masing...</marquee></h2>
										</div>
										<div class="card-body">
											<div class="row">
												<div class="col-md-2">
												...
												<div class="col-md-10">
													...
													<div class="p-3 border rounded">
														...
														<h4>Setelah 3 x 24 jam belum melakukan submit berkas, maka secara otomatis akan muncul tombol pengajuan alasan terlambat seperti dibawah ini:</h4>
