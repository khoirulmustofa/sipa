								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-8 bg-light rounded">
											<form action="<?php echo base_url('upm/laporan_tatap_muka')?>" method="post">
												<div class="row">
													<div class="col-md-8">
										...
										<div class="col-md-4 bg-light rounded">
											<?php if(isset($_SESSION['id_pertemuan_search']) && isset($_SESSION['bulan_search']) && isset($_SESSION['orderby'])){ ?>
												<!-- <div class="form-group text-left">
													...
													<a href="<?= base_url('upm/laporan_tatap_muka/cetak/'.$_SESSION['id_pertemuan_search'])?>" target="_BLANK" class="btn btn-warning"><i class="fas fa-print"></i>  CETAK LAPORAN TATAP MUKA</a>
												</div> -->
