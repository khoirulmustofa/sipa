				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h1 class="text-white pb-2 fw-bold">TATA TERTIB UJIAN</h1>
						...
						<!-- ============ MODAL UPLOAD BUKTI FOTO =============== -->
								...
								<div class="modal fade" id="modal_upload_file<?php echo $id_ujian;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
										...
										<div class="modal-header bg-success">
											<h3 class="modal-title" id="myModalLabel">Upload Berkas Tata Tertib</h3>
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
										</div>
										<form class="form-horizontal" method="post" action="<?php echo base_url().'tu/tata_tertib/upload'?>" enctype="multipart/form-data">
											<div class="modal-body">
												<div class="form-group">
													...
													<div class="col-xs-8">
														<input type="file" name="berkas" class="border-secondary text-dark" required>
													</div>
												</div>
											</div>
							...
							<!-- ============ MODAL HAPUS =============== -->
								<div class="modal fade" id="modal_hapus<?php echo $id_ujian;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<div class="modal-header bg-danger">
										<h3 class="modal-title" id="myModalLabel">Hapus Berkas Tata Tertib</h3>
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
									</div>
									<form class="form-horizontal" method="post" action="<?php echo base_url().'tu/tata_tertib/hapus_berkas'?>">
										<div class="modal-body">
											<p>Anda yakin ingin menghapus berkas tata tertib ujian untuk tahun ajaran <b><?php echo $tahun_ajaran.'->'.$semester.'->'.$nama_ujian;?></b>?</p>
										</div>
										<div class="modal-footer">
											<input type="hidden" name="id_ujian" value="<?php echo $id_ujian;?>">
											<input type="hidden" name="berkaslama" value="<?php echo $file_tata_tertib;?>">
											<button class="btn" data-dismiss="modal" aria-hidden="true">Tutup</button>
