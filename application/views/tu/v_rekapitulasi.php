								...
								<?php if(isset($_SESSION['id_ujian_search'])){ ?>
									<div class="dropdown">
									  ...
									  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									    <a class="dropdown-item" href="<?php echo base_url('tu/rekapitulasi/cetak/'.$_SESSION['id_ujian_search']);?>" target="_BLANK">PDF</a>
									    <a class="dropdown-item" href="<?php echo base_url('tu/cetak_rekapitulasi_excel');?>" target="_BLANK">Excel</a>
									  </div>
									</div>
