				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h1 class="text-white pb-2 fw-bold">PERMINTAAN VERIFIKASI</h1>
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-12 bg-light rounded">
											<form action="<?php echo base_url('prodi/permintaan_verifikasi')?>" method="post">
												<div class="row">
	...
	<script type="text/javascript" language="javascript" >
		$(document).ready(function() {
			var dataTable = $('#dataku').DataTable( {
				...
				"ajax":{
					url :"<?= base_url('prodi/permintaan_verifikasi/get_ajax');?>",
					type: "post",
					error: function(){
						$(".dataku-error").html("");
