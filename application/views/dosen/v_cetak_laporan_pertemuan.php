...
<html lang="en">
    ...
    <?php
        ...
        if($id_jadwal_kelas_pertemuan!=null){
                ...
                $query = $this->m_presensi_pertemuan->selectCetakLaporanPertemuan($id_jadwal_kelas_pertemuan);
                if($query->num_rows()==1){
    ...
    ?>
                    ...
                    <?php 
                        ...
                        for ($i=0; $i < $jumlah_pertemuan; $i++) { 
                            $cek = $this->m_presensi_pertemuan->ambilPresensiPertemuan($id_jadwal_kelas_pertemuan, ($i+1));
                            if(($i+1)==8){
                    ?>
                                <tr>
                                    <td><?= ($i+1) ?></td>
                    ...
                    <?php
                            ...
                            elseif($cek){
                                ...
                                $hari = $this->m_presensi_pertemuan->hari(date('Y-m-d', strtotime($waktu_pertemuan)));

                                
                                $tanggal_pertemuan = $this->m_presensi_pertemuan->format_tanggal(date('Y-m-d', strtotime($waktu_pertemuan)));
                    ...
                    ?>
                            <tr> 
                                ...
                                <td width="60">
                                    <?php
                                        $getIdRandom = $this->m_presensi_pertemuan->getIdRandom($id_presensi_pertemuan);
                                        if($getIdRandom!=null){
                                    ...
                                    <i class="text-success text-center" id="textkecil"><small><?= $this->m_presensi_pertemuan->getPenandaTangan($getIdRandom) ?></small></i>
                                     <?php                                            
                                        }
                                    ?>
                                </td>
                    ...
                    <table id="table2">
                        <tr>
                            <td>
                                ...
                                <?php
                                        $getIdRandom = $this->m_presensi_pertemuan->getIdRandomTddWd1($id_jadwal_kelas_pertemuan);
                                        if($getIdRandom!=null){
                                ...
                                <?php
                                   ...
                                   $topik_relasi_ttd_wd1 = "Kelas Pertamuan (Persetujuan Laporan Presensi Oleh Wakil Dekan I)";
                                    if($this->m_presensi_pertemuan->getNamaTtd($id_jadwal_kelas_pertemuan, $topik_relasi_ttd_wd1)!=""){
                                        echo $this->m_presensi_pertemuan->getNamaTtd($id_jadwal_kelas_pertemuan, $topik_relasi_ttd_wd1);
                                    }else{
                                       $nama_wd1 = $this->m_presensi_pertemuan->ambilNamaWd1();
                                        if($nama_wd1!=null){
                                            echo $nama_wd1;
                                        }else{
                                            echo '.........................';
                            ...
                            <td>
                                ...
                                <?php  
                                    ...
                                    $hari_sekarang = $this->m_presensi_pertemuan->hari(date('Y-m-d', strtotime($sekarang)));
                                    $tanggal_sekarang = $this->m_presensi_pertemuan->format_tanggal(date('Y-m-d', strtotime($sekarang)));
                            ...
                            <td>
                                ...
                                <?php
                                        $getIdRandom = $this->m_presensi_pertemuan->getIdRandomTddProdi($id_jadwal_kelas_pertemuan);
                                        if($getIdRandom!=null){
                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION['kode_jurusan'])){
                                        ...
                                        if($this->m_presensi_pertemuan->getNamaTtd($id_jadwal_kelas_pertemuan, $topik_relasi_ttd_prodi)!=""){
                                            echo $this->m_presensi_pertemuan->getNamaTtd($id_jadwal_kelas_pertemuan, $topik_relasi_ttd_prodi);
                                        }else{
                                           $nama_kaprodi = $this->m_presensi_pertemuan->ambilNamaKaProdi($kode_jurusan);
