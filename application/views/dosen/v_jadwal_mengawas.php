										...
										<?php 
											...
											<tr>
												...
												<td style="width: 220px;" class="text-white">
													...
													?>
																				<a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_absensi<?php echo $id_jadwal_lanjutan;?>"><i class="fa fa-user-check"></i> Absensi</a>
