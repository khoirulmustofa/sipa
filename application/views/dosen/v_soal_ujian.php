					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-12 bg-light rounded">
											<form action="<?php echo base_url('dosen/soal_ujian')?>" method="post">
												<div class="row">
								...
								<a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_upload_file"><i class="fa fa-upload"></i> Unggah Berkas</a>
									<hr>
						...
						<!-- ============ MODAL UPLOAD BUKTI FOTO =============== -->
								...
								<div class="modal fade" id="modal_upload_file" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
										...
										<form class="form-horizontal" method="post" action="<?php echo base_url().'dosen/soal_ujian/upload'?>" enctype="multipart/form-data">
													...
													<select name="id_jadwal_kelas_pertemuan" class="form-control" required>
														...
														<?php
															foreach($combobox_kelas_diampu->result_array() as $i):
																...
																if($this->m_soal_ujian->cekKetersediaanfileBerkasSoalUjian($_SESSION['id_ujian_search'], $id_jadwal_kelas_pertemuan_combo)==0){
														?>
							...
							<!-- ============ MODAL HAPUS =============== -->
								<div class="modal fade" id="modal_hapus<?php echo $id_berkas_ujian_kelas;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
									...
									<form class="form-horizontal" method="post" action="<?php echo base_url().'dosen/soal_ujian/hapus_berkas'?>">
										<div class="modal-body">
