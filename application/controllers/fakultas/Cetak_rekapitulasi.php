...
class Cetak_rekapitulasi extends CI_Controller {
    ...
    function index()
    {
        ...
        $pdf->Cell(50,$TinggiSemua,'Nama Pengawas',1,0,'C');
        $pdf->Cell(65,$TinggiSemua,'Matakuliah',1,0,'C');
        ...
        $pdf->Cell(20,$TinggiSemua,'Mhs/Dsn',1,0,'C');
        ...
        foreach($x->result_array() as $i):
            ...
            if($rowspan==false){
                // $pdf->Cell(50,$TinggiSemua,$nama_dosen,'L,T,R',0,'L');
                $pdf->Cell(20,$TinggiSemua,$count_mhs,'L,T,R',0,'C');
                ...
                $pdf->Cell(20,$TinggiSemua,'','R,L',0,'C');
        ...
        $pdf->Cell(20,$TinggiSemua,$tot_mhs_hadir2,1,0,'C');
